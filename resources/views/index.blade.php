...
@section('content')
    ...
    <div class="part5">
        ...
        <div class="text">
            <p>مجموعه‌ای از افراد فعال در زمینه ارزهای دیجیتال هستیم که با توجه به کمبودها، نارسایی‌ها و مشکلات مختلف برآن
                شدیم تا با ایجاد یک صرافی مطمئن خدمات دقیق، امن، سریع و راحت و با حداقل کارمزد را در اختیار مشتریان و
                علاقه‌مندان این حوزه قرار دهیم.
                ما در «بیست‌بیت» همه تلاش خود را بر پشتیبانی لحظه‌ای و دقیق معطوف کرده‌ایم و بر اصل مهم ارائه خدمات با کیفیت
                و پشتیبانی دقیق اصرار داریم.
                ما تلاش می‌کنیم که همواره رضایت مشتریان را از لحظه ورود به پلتفرم‌های موجودمان کسب کرده و جای خالی یک صرافی
                مطمئن و بدون انگیزه‌های سودآورانه کاذب را پر کنیم.</p>
        </div>
    </div>
    ...
    <script>
        ...
        const para2 = () => {
            ...
            $('.spin>img').css('transform', 'rotate(' + ((num_spin * 22.5) - 20) + 'deg)')
            $('.spin>img').fadeIn(500)

            switch (num_case) {
                case num_spin:
                    $('#show-award').text(' شما برنده ' + name_awrads_par + ' شدید. ');
                    break;
            }
            $('.spin>img').fadeIn(500)
    ...
    @isset($awrads)
        ...
        foreach ($awrads as $item) {
            ...
            echo '<script type="text/javascript">', 'spin(' . $number . ',"' . $item->name . '");', 'setTimeout(para2, 5000);', '</script>';
        }
