...
<!-- Hero section end -->
    ...
    <div class="text">
        <h2>گردونه شانس!</h2>
        <b>نکته:</b>
        <p>توجـه داشـته باشید که شما در
            <br> هر هفته تا پایان کمـپین فرصت
            <br>گردانـدن چرخـونـه بـرای در یافت
            <br> جوایز بـیـشتـر خواهیــد داشـت.
            <br><br>با دعوت از دوستانتان میتوانید
            <br>تـعـداد دفـعـات بیشتری اقدام  به
            <br>گـرانـدن چــرخــونــه نــمـــایــیــد
        </p>
    </div>
</div>
